...
interface ComplianceCartridgeEasterEggModalProps {
  open: boolean;
  onClose: () => void;
}

export function ComplianceCartridgeEasterEggModal({ open, onClose }: ComplianceCartridgeEasterEggModalProps) {
  ...
  return (
    <div className="easter-egg-modal-bg" onClick={handleBackdrop} role="presentation">
      ...
      >
        ...
        <p className="easter-egg-tagline">You found the node. Trust verified.</p>
      </div>
    </div>
  );
}
