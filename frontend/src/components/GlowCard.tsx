...
const GlowCard: React.FC<GlowCardProps> = ({
  ...
  return (
    <>
      ...
      <div ref={cardRef} data-glow style={getInlineStyles()} className={`${getSizeClasses()} ${!customSize ? 'aspect-[3/4]' : ''} rounded-2xl relative grid shadow-[0_1rem_2rem_-1rem_black] backdrop-blur-[5px] ${className}`}>
